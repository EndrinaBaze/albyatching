                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                    <c:forEach items="${listBunkerQuote}" var="bunkerQuote">
                                        <tr class="gradeC">
                                            <td>${bunkerQuote.id}</td>
                                            <td>${bunkerQuote.name}</td>
                                            <td>${bunkerQuote.lastname}</td>
                                            <td>${bunkerQuote.email}</td>
                                            <td>${bunkerQuote.phoneNumber}</td>
                                            <td>${bunkerQuote.quantity}</td>
                                            <td>${bunkerQuote.dutyfreeCity}</td>
                                            <td>${bunkerQuote.comments}</td>
                                            <td style="width: 5%;">
                                                <table>
                                                    <tr>
                                                        <td>

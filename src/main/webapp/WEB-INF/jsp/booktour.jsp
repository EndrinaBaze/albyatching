                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                    <c:forEach items="${listBookTour}" var="bookTour">
                                        <tr class="gradeC">
                                            <td>${bookTour.id}</td>
                                            <td>${bookTour.name}</td>
                                            <td>${bookTour.lastname}</td>
                                            <td>${bookTour.email}</td>
                                            <td>${bookTour.phoneNumber}</td>
                                            <td>${bookTour.bookingDate}</td>
                                            <td>${bookTour.message}</td>
                                            <td>${bookTour.agents.name} ${bookTour.agents.lastname}</td>
                                            <td style="width: 5%;">
                                                <table>
                                                    <tr>
                                                        <td>
